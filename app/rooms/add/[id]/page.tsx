...
const ThankYou = () => {
  ...
  const roomName = searchParams.get("roomName") || "N/A";
  const description =
    searchParams.get("description") || "No description available";
  const sqft = searchParams.get("sqft") || "Unknown";
  const capacity = searchParams.get("capacity") || "Unknown";
  const pricePerHour = searchParams.get("pricePerHour") || "Unknown";
  const address = searchParams.get("address") || "Unknown";
  const location = searchParams.get("location") || "Unknown";
  const availability = searchParams.get("availability") || "Unknown";
  const amenities = searchParams.get("amenities") || "No amenities listed";
  ...
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <main className="relative lg:min-h-full">
        ...
        <li>Size: {sqft} ft²</li>
        <li>Capacity: {capacity} people</li>
